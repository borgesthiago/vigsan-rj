 ...
 */
final class Version20200512171525 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cidadao ADD CONSTRAINT FK_9D4D3AC77C3EAC6 FOREIGN KEY (comorbidade_id) REFERENCES comorbidade (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
